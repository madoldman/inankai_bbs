/* $Id: usage.c,v 1.3 2009-03-29 14:12:20 madoldman Exp $ */
...
char *argv[];
{
  ...
  while (fgets(buf, 256, fp))
  {
   ...
   if(mode==1)
   {
        fprintf(op,"[1;37mÃû´Î %-21.21s%-28.28s %5s %8s %10s[m\n","ÌÖÂÛÇøÃû³Æ","ÖÐÎÄÐðÊö","ÈË´Î","ÀÛ»ýÊ±¼ä","Æ½¾ùÊ±¼ä");
   }else
   {
