...
#define MAXGUEST			1000	   /* 最多 guest 帐号上站个数 */
#define MAXGUESTPERIP		  	10	   /* 每个 IP 同时上站 id 数 */
...
#define MAX_ENDLINE			 60 /* 最大底线页面数 bluetent 2002.1.2*/
#define MAX_DIGEST         3000    /* 最大文摘数 */
#define MAX_POSTRETRY       100
#define PMAXRMD		    4	    /*最大推荐数*/
...
#define FILE_ONTOP 0x2		/* Efan: 被置底文章的属性位	*/
#define FILE_TIP 0X4		/* Efan: 置底文章(显示为[置底])	*/
#define FILE_STYLE1 0X8
#define FILE_STYLE2 0X10 
#define FILE_STYLE3 0X20
#define FILE_STYLE4 0X40
#define FILE_STYLE5 0X80      /*loveni:多种置底提示*/
...
/* for flag2	 by loveni */
#define HIDE_FLAG 0x1   		/*俱乐部板面是否隐藏 */
#define JUNK_FLAG 0x2  			/* 是否算文章数 */
#define NOTOPTEN_FLAG 0x4			/* 是否参与十大统计 */
#define NOFILTER_FLAG 0x8		/* 是否过滤敏感字	 */  
#define TEMPLATE_FLAG 0x10		/* 是否强制模板发文	  */		
#define VBOARD_FLAG 0x20	/* 虚拟版面 */
...
//commands结构未找到声明，这几个数组也未使用，
//注释掉这几句后，在gcc-4.0下编译通过
