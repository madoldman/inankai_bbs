...
#define PASSAFTERONEDAYS	/* 三天是不是太长了，一天也差不多 */
...
/* 某些限制性代码的相关 define */
#define BOARD_CONTROL		/* 提供成员板面设置功能 Ctrl+Y */
...
#define DOMAIN_NAME		/* 登陆时解析部分IP为域名 */
...
#define AUTOGETPERM		/* 无需注册即获取基本权限 */
#define SYSOPLOGINPROTECT 	/* SYSOP 帐号登陆安全 */
//#undef DOMAIN_NAME		/* 登陆时进行域名反查 */
#endif


#define MAILRECYCLE  /*   邮件回收功能*/
/* Efan: 使用奖章	*/
#define ALLOW_MEDALS
