...
char   *msg;
{
	...
	sprintf(chatbuf, "[1;37m¡ï [32m[[36m%s[32m] ½«ÁÄÌìÊÒÃû³Æ¸ÄÎª [1;33m%.11s [37m¡ï[m", users[unum].chatid, msg);
	send_to_room(rnum, chatbuf);
}
...
char   *msg;
{
	...
	send_to_room(rnum, chatbuf);
	sprintf(chatbuf, "[1;37m¡ï [32m[[36m%s[32m] ½«»°Ìâ¸ÄÎª [1;33m%42.42s [37m¡ï[m", users[unum].chatid, msg);
	send_to_room(rnum, chatbuf);
}
...
struct action party_data[] =
    {
	    ...
	    {"wakeup","Ò¡Öø","£¬ÊÔÖø°ÑËû½ĞĞÑ¡£´óÉùÔÚËû¶ú±ß´ó½Ğ£º¡¸ Öí! ÆğÀ´ÁË! ¡¹"},
	    {"wave", "¶ÔÖø", "Æ´ÃüµÄÒ¡ÊÖ"},
	    {"welcome", "ÈÈÁÒ»¶Ó­", "µÄµ½À´"},
	    {"wink", "¶Ô", "ÉñÃØµÄÕ£Õ£ÑÛ¾¦"},
	    {"zap", "¶Ô", "·è¿ñµÄ¹¥»÷"},
	    {"xinku","¸Ğ¶¯µÃÈÈÀáÓ¯¿ô£¬Ïò×Å","Õñ±Û¸ßºô£º¡°Ê×³¤ĞÁ¿àÁË£¡¡±"},
	    {"bupa", "°®Á¯µØÃş×Å", "µÄÍ·,Ëµ:¡°Ğ¡ÃÃÃÃ,²»ÅÂ,ÊÜÁËÊ²Ã´Î¯Çü´ó¸ç¸çÌæÄã±¨³ğ!¡±"},  {"gril", "¸Ï½ô¸ø", "´·´·±³,ĞÄÏë:º¢×ÓĞ¡,±ğ²í¹ıÆøÈ¥."},
...
struct action condition_data[] =
    {
	    ...
	    {"blush", "Á³¶¼ºìÁË", NULL},
	    {"boss","·ÅÉù´ó½Ğ£ºÍÛÈû£¬²»µÃÁË£¬ÀÏ°åÀ´ÁË£¬ÎÒÒªÌÓÁË£¬ÔÙ¼ûÁË¸÷Î».",NULL},
	    ...
	    {"suicide", "ÕæÏëÂò¿é¶¹¸¯À´Ò»Í·×²ËÀ, ÃşÁËÃşÉí±ßÓÖÃ»ÁãÇ®, Ö»ºÃÈÌÒ»ÊÖ", NULL},
