...
int frame_input(int pid)
{
        printf("\
               ...
               <option value='//happy'>ºÃ¸ßÐË°¡</option>\
               ...
               <option value='//grin'>ßÖ×ìÐ¦</option>\
...
\
               ¡¾ Verb + Message£º¶¯´Ê + ÒªËµµÄ»° ¡¿   Àý£ºsing ÌìÌìÌìÀ¶\
               ...
               */\
               ...
               <br>\
               <a href='javascript:do_quit()'>[Àë¿ªbbs²è¹Ý] </a>\
        ...
        if(fp)
                while(1) {
                        ...
                        if(!strncmp(genbuf, "/t", 2)) {
                                int i;
                                printf("<script>top.document.title='bbs²è¹Ý--»°Ìâ: ");
                                hprintf(genbuf+2);
                                printf("'</script>");
